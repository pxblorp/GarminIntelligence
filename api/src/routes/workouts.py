...
@workouts_bp.route('/api/workouts/<workout_id>', methods=['DELETE'])
...
@workouts_bp.route('/api/calendar', methods=['GET'])
def get_calendar():
    """
...
@workouts_bp.route('/api/calendar', methods=['POST'])
...
@workouts_bp.route('/api/calendar/<date>/<scheduled_id>', methods=['DELETE'])
...
@workouts_bp.route('/api/export/week', methods=['GET'])
def export_week():
    """
...
@workouts_bp.route('/api/export/workout/<scheduled_id>', methods=['GET'])
